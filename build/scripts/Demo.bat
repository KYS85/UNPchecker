...
set CLASSPATH=%APP_HOME%\lib\Demo-1.0-SNAPSHOT.jar;%APP_HOME%\lib\gson-2.9.1.jar;%APP_HOME%\lib\JCDP-2.0.3.1.jar;%APP_HOME%\lib\jansi-1.15.jar


@rem Execute Demo
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %DEMO_OPTS%  -classpath "%CLASSPATH%" project.Upd %*
